...
export function LandingPageContentBottom() {
  return (
    <div className="p-8">
      ...
      <ul className="list-disc pl-5 space-y-2">
        <li className="pl-2">
          <span className="block">Secure funds until obligations are met.</span>
        </li>
        <li className="pl-2">
          <span className="block">Build confidence with verified service providers.</span>
        </li>
        <li className="pl-2">
          <span className="block">Access efficient dispute resolution when needed.</span>
        </li>
      </ul>
      ...
      <ul className="list-disc pl-5 space-y-2">
        <li className="pl-2">
          <span className="block">Assurance of payment for work completed.</span>
        </li>
        <li className="pl-2">
          <span className="block">Reduced risk of fraud or non-payment.</span>
        </li>
        <li className="pl-2">
          <span className="block">Structured, transparent transactions.</span>
        </li>
      </ul>
      ...
      <ul className="list-disc pl-5 space-y-2 mb-4">
        <li className="pl-2">
          <span className="block">Flexible payment models, including crypto and fiat.</span>
        </li>
        <li className="pl-2">
          <span className="block">Enhanced trust and reduced financial risk.</span>
        </li>
        <li className="pl-2">
          <span className="block">A streamlined process tailored for modern digital needs.</span>
        </li>
      </ul>
